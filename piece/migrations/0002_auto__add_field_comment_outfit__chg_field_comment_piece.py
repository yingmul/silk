...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.outfit'
        db.add_column(u'piece_comment', 'outfit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sell.Outfit'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Comment.piece'
        db.alter_column(u'piece_comment', 'piece_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sell.Piece'], null=True))

    def backwards(self, orm):
        # Deleting field 'Comment.outfit'
        db.delete_column(u'piece_comment', 'outfit_id')


        # Changing field 'Comment.piece'
        db.alter_column(u'piece_comment', 'piece_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sell.Piece']))
