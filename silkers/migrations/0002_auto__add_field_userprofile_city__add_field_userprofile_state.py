...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'silkers_userprofile', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.state'
        db.add_column(u'silkers_userprofile', 'state',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'silkers_userprofile', 'city')

        # Deleting field 'UserProfile.state'
        db.delete_column(u'silkers_userprofile', 'state')
