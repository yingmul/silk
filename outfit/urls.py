...
from outfit.views import OutfitDetailView, OutfitCommentView, OutfitDeleteView, like_outfit, get_outfit_pictures

urlpatterns = patterns('',
    url(r'^detail/(?P<pk>\d+)$', OutfitDetailView.as_view(), name='outfit-detail'),
    url(r'^delete/(?P<pk>\d+)$', OutfitDeleteView.as_view(), name='delete'),
