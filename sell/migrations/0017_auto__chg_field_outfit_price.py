...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Outfit.price'
        db.alter_column(u'sell_outfit', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Outfit.price'
        db.alter_column(u'sell_outfit', 'price', self.gf('django.db.models.fields.DecimalField')(default=39.99, max_digits=8, decimal_places=2))
    ...
    models = {
        ...
        u'sell.picture': {
            'Meta': {'ordering': "['-is_primary']", 'object_name': 'Picture'},
