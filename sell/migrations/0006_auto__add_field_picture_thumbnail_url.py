...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Picture.thumbnail_url'
        db.add_column(u'sell_picture', 'thumbnail_url',
                      self.gf('django.db.models.fields.URLField')(default='http://localhost:8000/media/one-off-photo-url.jpg', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Picture.thumbnail_url'
        db.delete_column(u'sell_picture', 'thumbnail_url')
