...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Piece.price'
        db.alter_column(u'sell_piece', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Piece.price'
        db.alter_column(u'sell_piece', 'price', self.gf('django.db.models.fields.IntegerField')())
