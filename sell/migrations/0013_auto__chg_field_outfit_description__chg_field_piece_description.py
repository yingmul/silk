...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Outfit.description'
        db.alter_column(u'sell_outfit', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Piece.description'
        db.alter_column(u'sell_piece', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Outfit.description'
        db.alter_column(u'sell_outfit', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Piece.description'
        db.alter_column(u'sell_piece', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
