...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Picture.type'
        db.alter_column(u'sell_picture', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=1))

    def backwards(self, orm):

        # Changing field 'Picture.type'
        db.alter_column(u'sell_picture', 'type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
