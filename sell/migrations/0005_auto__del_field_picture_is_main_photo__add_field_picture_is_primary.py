...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Picture.is_main_photo'
        db.delete_column(u'sell_picture', 'is_main_photo')

        # Adding field 'Picture.is_primary'
        db.add_column(u'sell_picture', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Picture.is_main_photo'
        db.add_column(u'sell_picture', 'is_main_photo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Picture.is_primary'
        db.delete_column(u'sell_picture', 'is_primary')
