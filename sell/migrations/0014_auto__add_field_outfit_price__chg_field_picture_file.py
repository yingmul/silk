...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Outfit.price'
        db.add_column(u'sell_outfit', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=50.0, max_digits=8, decimal_places=2),
                      keep_default=False)


        # Changing field 'Picture.file'
        db.alter_column(u'sell_picture', 'file', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Outfit.price'
        db.delete_column(u'sell_outfit', 'price')


        # Changing field 'Picture.file'
        db.alter_column(u'sell_picture', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
