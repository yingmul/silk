...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Picture.piece'
        db.add_column(u'sell_picture', 'piece',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sell.Piece'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Picture.type'
        db.add_column(u'sell_picture', 'type',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Picture.piece'
        db.delete_column(u'sell_picture', 'piece_id')

        # Deleting field 'Picture.type'
        db.delete_column(u'sell_picture', 'type')
