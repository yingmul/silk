...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Piece.outfit'
        db.alter_column(u'sell_piece', 'outfit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sell.Outfit'], null=True))

    def backwards(self, orm):

        # Changing field 'Piece.outfit'
        db.alter_column(u'sell_piece', 'outfit_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sell.Outfit']))
