...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Piece.size'
        db.add_column(u'sell_piece', 'size',
                      self.gf('django.db.models.fields.CharField')(default='XS', max_length='5'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Piece.size'
        db.delete_column(u'sell_piece', 'size')
