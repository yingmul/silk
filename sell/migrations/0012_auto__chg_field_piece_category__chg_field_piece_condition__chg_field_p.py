...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Piece.category'
        db.alter_column(u'sell_piece', 'category', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Piece.condition'
        db.alter_column(u'sell_piece', 'condition', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Piece.size'
        db.alter_column(u'sell_piece', 'size', self.gf('django.db.models.fields.CharField')(max_length=5))
